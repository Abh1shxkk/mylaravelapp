...
@section('title','Add Sale Ledger Entry')
@section('content')
<div class="d-flex justify-content-between align-items-center mb-3">
  <div>
    <h4 class="mb-0 d-flex align-items-center"><i class="bi bi-cart-check me-2"></i> Add Sale Ledger Entry</h4>
    <div class="text-muted small">Create a new sale ledger entry</div>
  </div>
...
<div class="card shadow-sm">
  <div class="card-body">
    <form action="{{ route('admin.sale-ledger.store') }}" method="POST">
      @csrf
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input type="text" class="form-control @error('ledger_name') is-invalid @enderror" 
                 id="ledger_name" name="ledger_name" value="{{ old('ledger_name') }}" placeholder="e.g., SALE - TAXPAID" required>
          @error('ledger_name')
        ...
        <div class="col-md-6 mb-3">
          ...
          <input type="text" class="form-control @error('form_type') is-invalid @enderror" 
                 id="form_type" name="form_type" value="{{ old('form_type') }}" placeholder="Form Type">
          @error('form_type')
          <div class="invalid-feedback">{{ $message }}</div>
          @enderror
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-3">
          ...
          <select class="form-select @error('type') is-invalid @enderror" id="type" name="type">
            ...
            <option value="L" {{ old('type') == 'L' ? 'selected' : '' }}>L (Ledger)</option>
            <option value="C" {{ old('type') == 'C' ? 'selected' : '' }}>C (Credit)</option>
          </select>
          @error('type')
          <div class="invalid-feedback">{{ $message }}</div>
          @enderror
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input type="text" class="form-control @error('alter_code') is-invalid @enderror" 
                 id="alter_code" name="alter_code" value="{{ old('alter_code') }}" placeholder="Alternate Code">
          @error('alter_code')
          <div class="invalid-feedback">{{ $message }}</div>
          @enderror
        </div>
        ...
        <div class="col-md-6 mb-3">
          ...
          <input type="text" class="form-control @error('under') is-invalid @enderror" 
                 id="under" name="under" value="{{ old('under') }}" placeholder="Under which group/ledger">
          @error('under')
          <div class="invalid-feedback">{{ $message }}</div>
          @enderror
        </div>
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input type="text" class="form-control @error('contact_1') is-invalid @enderror" 
                 id="contact_1" name="contact_1" value="{{ old('contact_1') }}" placeholder="Contact Person 1">
          @error('contact_1')
          <div class="invalid-feedback">{{ $message }}</div>
          @enderror
        </div>
        ...
        <div class="col-md-6 mb-3">
          ...
          <input type="text" class="form-control @error('mobile_1') is-invalid @enderror" 
                 id="mobile_1" name="mobile_1" value="{{ old('mobile_1') }}" placeholder="Mobile 1">
          @error('mobile_1')
          <div class="invalid-feedback">{{ $message }}</div>
          @enderror
        </div>
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input type="text" class="form-control @error('contact_2') is-invalid @enderror" 
                 id="contact_2" name="contact_2" value="{{ old('contact_2') }}" placeholder="Contact Person 2">
          @error('contact_2')
          <div class="invalid-feedback">{{ $message }}</div>
          @enderror
        </div>
        ...
        <div class="col-md-6 mb-3">
          ...
          <input type="text" class="form-control @error('mobile_2') is-invalid @enderror" 
                 id="mobile_2" name="mobile_2" value="{{ old('mobile_2') }}" placeholder="Mobile 2">
          @error('mobile_2')
          <div class="invalid-feedback">{{ $message }}</div>
          @enderror
        </div>
      ...
      <div class="d-flex gap-2">
        <button type="submit" class="btn btn-primary">
          <i class="bi bi-save me-1"></i> Save Sale Ledger Entry
        </button>
