...
@section('title','Add General Ledger Account')
@section('content')
<div class="d-flex justify-content-between align-items-center mb-3">
  <div>
    <h4 class="mb-0 d-flex align-items-center"><i class="bi bi-journal-text me-2"></i> Add General Ledger Account</h4>
    <div class="text-muted small">Create a new ledger account</div>
  </div>
...
<div class="card shadow-sm">
  <div class="card-body">
    <form action="{{ route('admin.general-ledger.store') }}" method="POST">
      @csrf
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input type="text" class="form-control" 
                 id="under" name="under" value="{{ old('under') }}" placeholder="e.g., CURRENT LIABILITIES">
        </div>
        ...
        <div class="col-md-3 mb-3">
          ...
          <select class="form-select" 
            ...
            <option value="C" {{ old('balance_type', 'C') == 'C' ? 'selected' : '' }}>Cr</option>
            <option value="D" {{ old('balance_type') == 'D' ? 'selected' : '' }}>Dr</option>
          </select>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input type="text" class="form-control" 
                 id="address_line3" name="address_line3" value="{{ old('address_line3') }}">
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-3">
          ...
          <input type="text" class="form-control" 
                 id="contact_person_1_mobile" name="contact_person_1_mobile" value="{{ old('contact_person_1_mobile') }}">
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input type="text" class="form-control" 
                 id="contact_person_2_mobile" name="contact_person_2_mobile" value="{{ old('contact_person_2_mobile') }}">
        </div>
      </div>
