                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" name="code" value="{{ old('code', $supplier->code) }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">T(ax)/R(etail)</label>
                                <select class="form-select" name="tax_retail_flag">
                                    <option value="T" {{ old('tax_retail_flag', $supplier->tax_retail_flag ?? 'T') == 'T' ? 'selected' : '' }}>T</option>
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control @error('telephone') is-invalid @enderror" name="telephone" value="{{ old('telephone', $supplier->telephone) }}">
                                @error('telephone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" name="status" id="status" {{ old('status', $supplier->status) ? 'checked' : '' }}>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" name="contact_person_1" value="{{ old('contact_person_1', $supplier->contact_person_1) }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Contact Person II</label>
                                <input type="text" class="form-control" name="contact_person_2" value="{{ old('contact_person_2', $supplier->contact_person_2) }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Mobile</label>
                                <input type="text" class="form-control" name="mobile" value="{{ old('mobile', $supplier->mobile) }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Mobile Additional</label>
                                <input type="text" class="form-control" name="mobile_additional" value="{{ old('mobile_additional', $supplier->mobile_additional) }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Flag</label>
                                <input type="text" class="form-control" name="flag" value="{{ old('flag', $supplier->flag) }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Visit Days</label>
                                <input type="text" class="form-control" name="visit_days" value="{{ old('visit_days', $supplier->visit_days) }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" name="dl_no" value="{{ old('dl_no', $supplier->dl_no) }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">D.L No. 1</label>
                                <input type="text" class="form-control" name="dl_no_1" value="{{ old('dl_no_1', $supplier->dl_no_1) }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Food Lic.</label>
                                <input type="text" class="form-control" name="food_lic" value="{{ old('food_lic', $supplier->food_lic) }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">MSME Lic.</label>
                                <input type="text" class="form-control" name="msme_lic" value="{{ old('msme_lic', $supplier->msme_lic) }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <label class="form-label">CST No.</label>
                                <input type="text" class="form-control" name="cst_no" value="{{ old('cst_no', $supplier->cst_no) }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">TIN No.</label>
                                <input type="text" class="form-control" name="tin_no" value="{{ old('tin_no', $supplier->tin_no) }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">GST No.</label>
                                <input type="text" class="form-control" name="gst_no" value="{{ old('gst_no', $supplier->gst_no) }}">
                            </div>
                            <div class="col-md-3 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" name="tan_no" value="{{ old('tan_no', $supplier->tan_no) }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">State Code</label>
                                <input type="text" class="form-control" name="state_code" value="{{ old('state_code', $supplier->state_code) }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Local/Central</label>
                                <select class="form-select" name="local_central_flag">
                                    <option value="L" {{ old('local_central_flag', $supplier->local_central_flag ?? 'L') == 'L' ? 'selected' : '' }}>Local</option>
                                    <option value="C" {{ old('local_central_flag', $supplier->local_central_flag) == 'C' ? 'selected' : '' }}>Central</option>
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Full Name</label>
                                <input type="text" class="form-control" name="full_name" value="{{ old('full_name', $supplier->full_name) }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control" name="opening_balance" value="{{ old('opening_balance', $supplier->opening_balance ?? '0.00') }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Credit Limit</label>
                                <input type="number" step="0.01" class="form-control" name="credit_limit" value="{{ old('credit_limit', $supplier->credit_limit ?? '0.00') }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Invoice Roff</label>
                                <input type="number" step="0.01" class="form-control" name="invoice_roff" value="{{ old('invoice_roff', $supplier->invoice_roff ?? '0.00') }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Direct/Indirect</label>
                                <select class="form-select" name="direct_indirect">
                                    <option value="D" {{ old('direct_indirect', $supplier->direct_indirect ?? 'D') == 'D' ? 'selected' : '' }}>Direct</option>
                                    <option value="I" {{ old('direct_indirect', $supplier->direct_indirect) == 'I' ? 'selected' : '' }}>Indirect</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" name="bank" value="{{ old('bank', $supplier->bank) }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Branch</label>
                                <input type="text" class="form-control" name="branch" value="{{ old('branch', $supplier->branch) }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">A/c No.</label>
                                <input type="text" class="form-control" name="account_no" value="{{ old('account_no', $supplier->account_no) }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">IFSC Code</label>
                                <input type="text" class="form-control" name="ifsc_code" value="{{ old('ifsc_code', $supplier->ifsc_code) }}">
                            </div>
                        </div>
                    </div>
                </div>
