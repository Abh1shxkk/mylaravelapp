    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <form action="{{ route('admin.customers.store') }}" method="POST" novalidate>
                    @csrf
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="tax_registration"
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="telephone_office"
                                        value="{{ old('telephone_office') }}">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="form-label">Telephone (Residence)</label>
                                    <input type="text" class="form-control" name="telephone_residence"
                                        value="{{ old('telephone_residence') }}">
                                </div>
                                 <div class="col-md-3 mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="contact_person1"
                                        value="{{ old('contact_person1') }}">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="form-label">Mobile Contact 1</label>
                                    <input type="text" class="form-control" name="mobile_contact1"
                                        value="{{ old('mobile_contact1') }}">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="form-label">Contact Person 2</label>
                                    <input type="text" class="form-control" name="contact_person2"
                                        value="{{ old('contact_person2') }}">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="form-label">Mobile Contact 2</label>
                                    <input type="text" class="form-control" name="mobile_contact2"
                                        value="{{ old('mobile_contact2') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="balance_type"
                                        value="{{ old('balance_type', 'D') }}" placeholder="Debit (D)/Credit (C)">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="form-label">Local/Central</label>
                                    <input type="text" class="form-control" name="local_central"
                                        value="{{ old('local_central', 'L') }}" placeholder="Local (L)/Central (C)">
                                </div>
                                <div class="col-md-3 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="business_type"
                                        value="{{ old('business_type', 'R') }}" placeholder="Retail (R)">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="form-label">Registration Status</label>
                                    <input type="text" class="form-control" name="registration_status"
                                        value="{{ old('registration_status') }}">
                                </div>
                                <div class="col-md-3 mb-3">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="due_list_sequence"
                                        value="{{ old('due_list_sequence') }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="date" class="form-control" name="registration_date"
                                        value="{{ old('registration_date', '2000-01-01') }}">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="form-label">End Date</label>
                                    <input type="date" class="form-control" name="end_date"
                                        value="{{ old('end_date', '2000-01-01') }}">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="form-label">Day Value</label>
                                    <input type="number" class="form-control" name="day_value"
                                        value="{{ old('day_value', '0') }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="form-check form-switch mt-2">
                                        <input class="form-check-input" type="checkbox" name="order_required"
                                            id="order_required" {{ old('order_required') ? 'checked' : '' }}>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="form-check form-switch mt-2">
                                        <input class="form-check-input" type="checkbox" name="invoice_export"
                                            id="invoice_export" {{ old('invoice_export') ? 'checked' : '' }}>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="cst_number"
                                        value="{{ old('cst_number') }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    <label class="form-label">CST Registration</label>
                                    <input type="text" class="form-control" name="cst_registration"
                                        value="{{ old('cst_registration') }}">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="form-label">GST Name <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control @error('gst_name') is-invalid @enderror"
                                        name="gst_name" value="{{ old('gst_name') }}">
                                    @error('gst_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="state_code_gst"
                                        value="{{ old('state_code_gst') }}">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="form-label">MSME License</label>
                                    <input type="text" class="form-control" name="msme_license"
                                        value="{{ old('msme_license') }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    <label class="form-label">Food License</label>
                                    <input type="text" class="form-control" name="food_license"
                                        value="{{ old('food_license') }}">
                                </div>
                                <div class="col-md-3 mb-3">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="dl_number1"
                                        value="{{ old('dl_number1') }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 mb-3">
