            ...
            <div class="row g-2">
                ...
                <div class="col-md-3">
                    <div class="mb-1 d-flex align-items-center">
                        ...
                        <input type="text" class="form-control form-control-xs" value="SR" readonly style="width: 50px;">
                    </div>
                    <div class="mb-1 d-flex align-items-center">
                    ...
                    <div class="mb-0 d-flex align-items-center">
                        ...
                        <input type="text" class="form-control form-control-xs" placeholder="6" style="width: 80px;">
                    </div>
                </div>
                    ...
                    <div class="row g-1 mb-1">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center justify-content-end">
                                <label class="form-label-sm me-2">Rate Diff :</label>
