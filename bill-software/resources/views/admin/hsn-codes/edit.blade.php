...
@section('title', 'Edit HSN Code')

@section('content')
<div class="container-fluid">
    <!-- Header -->
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">Edit HSN Code</h2>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.hsn-codes.update', $hsnCode) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                   name="name" value="{{ old('name', $hsnCode->name) }}" 
                                   placeholder="Enter HSN code name" required>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('hsn_code') is-invalid @enderror" 
                                   name="hsn_code" value="{{ old('hsn_code', $hsnCode->hsn_code) }}" 
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('cgst_percent') is-invalid @enderror" 
                                       name="cgst_percent" value="{{ old('cgst_percent', $hsnCode->cgst_percent) }}" 
                                       placeholder="0.00">
                                @error('cgst_percent')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('sgst_percent') is-invalid @enderror" 
                                       name="sgst_percent" value="{{ old('sgst_percent', $hsnCode->sgst_percent) }}" 
                                       placeholder="0.00">
                                @error('sgst_percent')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('igst_percent') is-invalid @enderror" 
                                       name="igst_percent" value="{{ old('igst_percent', $hsnCode->igst_percent) }}" 
                                       placeholder="0.00">
                                @error('igst_percent')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('total_gst_percent') is-invalid @enderror" 
                                       name="total_gst_percent" value="{{ old('total_gst_percent', $hsnCode->total_gst_percent) }}" 
                                       placeholder="0.00">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="is_inactive" 
                                           id="is_inactive" value="1" 
                                           {{ old('is_inactive', $hsnCode->is_inactive) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="is_service" 
                                           id="is_service" value="1" 
                                           {{ old('is_service', $hsnCode->is_service) ? 'checked' : '' }}>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-circle me-2"></i>Update HSN Code
                            </button>
                        </div>
                    </form>
                </div>
