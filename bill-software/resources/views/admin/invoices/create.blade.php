                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="customer_state_code"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control fw-bold" id="total_amount" value="₹0.00"
                                            readonly>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <textarea class="form-control" id="notes" name="notes" rows="3"
                                        placeholder="Additional notes for the invoice">{{ old('notes') }}</textarea>
                                </div>
                                <div class="col-md-6 mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('addItem').addEventListener('click', function() {
        ...
        // Select2 will be automatically initialized by the global MutationObserver
        // Just attach event listeners after a small delay to ensure Select2 is ready
        setTimeout(() => {
        ...
        if (itemSelect) {
            ...
            $(itemSelect).on('change', function() {
                ...
                if (selectedId && itemsData[selectedId]) {
                    ...
                    if (mrpInput) mrpInput.value = parseFloat(item.Mrp ?? 0) || 0;
    ...
    // Lazy initialize Select2 on item dropdowns
