    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <form action="{{ route('admin.invoices.update', $invoice) }}" method="POST" id="invoiceForm" novalidate>
                    @csrf
                    @method('PUT')
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-3 border-end">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="series" name="series" value="{{ old('series', $invoice->series) }}" placeholder="Series">
                                    </div>
                                    <div class="mb-2">
                                        <label class="form-label fw-bold mb-1 small">Date :</label>
                                        <input type="date" class="form-control form-control-sm" id="invoice_date" name="invoice_date" value="{{ old('invoice_date', $invoice->invoice_date) }}" required>
                                    </div>
                                    <div class="mb-2">
                                        <label class="form-label fw-bold mb-1 small">Inv.No :</label>
                                        <input type="text" class="form-control form-control-sm" id="invoice_number" name="invoice_number" value="{{ old('invoice_number', $invoice->invoice_number) }}" readonly>
                                    </div>
                                    <div class="mb-0">
                                        <label class="form-label fw-bold mb-1 small">Due Date :</label>
                                        <input type="date" class="form-control form-control-sm" id="due_date" name="due_date" value="{{ old('due_date', $invoice->due_date) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-9">
                                    <div class="row g-2">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="customer_name" name="customer_name" value="{{ old('customer_name', $invoice->customer_name) }}" placeholder="Customer Name">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label fw-bold mb-1 small">Sales Man</label>
                                            <input type="text" class="form-control form-control-sm" id="sales_man" name="sales_man" value="{{ old('sales_man', $invoice->sales_man) }}" placeholder="Sales Person">
                                        </div>
                                        <div class="col-md-4 text-end">
                                            <label class="form-label fw-bold mb-1 small">Cash :</label>
                                            <input type="number" class="form-control form-control-sm text-end" id="cash_amount" name="cash_amount" value="{{ old('cash_amount', $invoice->cash_amount ?? 0) }}" min="0" step="0.01" placeholder="0.00">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-2 mt-2" style="background-color: #fff9c4; padding: 8px; border-radius: 4px;">
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" class="form-control form-control-sm" id="due_amount" name="due_amount" value="{{ old('due_amount', $invoice->due_amount ?? 0) }}" readonly>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label fw-bold mb-1 small">PDC :</label>
                                            <input type="number" class="form-control form-control-sm" id="pdc_amount" name="pdc_amount" value="{{ old('pdc_amount', $invoice->pdc_amount ?? 0) }}" min="0" step="0.01">
                                        </div>
                                        <div class="col-md-4">
                        ...
                        <div class="card-body p-3">
                            <div class="row g-2">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="email" class="form-control form-control-sm" id="customer_email" name="customer_email" value="{{ old('customer_email', $invoice->customer_email) }}" placeholder="Email">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label fw-bold mb-1 small">Phone</label>
                                    <input type="text" class="form-control form-control-sm" id="customer_phone" name="customer_phone" value="{{ old('customer_phone', $invoice->customer_phone) }}" placeholder="Phone">
                                </div>
                            </div>
                            <div class="row g-2 mt-1">
                                <div class="col-md-6">
                                    <label class="form-label fw-bold mb-1 small">Address</label>
                                    <textarea class="form-control form-control-sm" id="customer_address" name="customer_address" rows="1" placeholder="Address">{{ old('customer_address', $invoice->customer_address) }}</textarea>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label fw-bold mb-1 small">GST Number</label>
                                    <input type="text" class="form-control form-control-sm" id="customer_gst" name="customer_gst" value="{{ old('customer_gst', $invoice->customer_gst) }}" placeholder="GST">
                                </div>
                                <div class="col-md-2">
                                    <label class="form-label fw-bold mb-1 small">State</label>
                                    <input type="text" class="form-control form-control-sm" id="customer_state" name="customer_state" value="{{ old('customer_state', $invoice->customer_state) }}" placeholder="State">
                                </div>
                                <div class="col-md-1">
                                    <label class="form-label fw-bold mb-1 small">Code</label>
                                    <input type="text" class="form-control form-control-sm" id="customer_state_code" name="customer_state_code" value="{{ old('customer_state_code', $invoice->customer_state_code) }}" placeholder="Code">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-sm mb-2" id="itemsTable">
                                   ...
                                   <tbody id="itemsTableBody">
                                        ...
                                        <tr>
                                            <td><input type="text" class="form-control item-code" name="items[{{ $index }}][code]" value="{{ $item->item->code ?? '' }}" placeholder="Code" readonly></td>
                                            <td>
                                                <select class="form-select item-select" name="items[{{ $index }}][item_id]">
                                                    <option value="">Select Item</option>
                                                    @foreach($items as $availableItem)
                                                        <option value="{{ $availableItem->id }}" {{ $item->product_id == $availableItem->id ? 'selected' : '' }}>
                                                            {{ $availableItem->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </td>
                                            <td><input type="text" class="form-control" name="items[{{ $index }}][description]" value="{{ $item->product_description }}" placeholder="Description"></td>
                                            <td><input type="text" class="form-control" name="items[{{ $index }}][hsn_code]" value="{{ $item->hsn_code }}" placeholder="HSN Code"></td>
                                            <td><input type="text" class="form-control" name="items[{{ $index }}][batch]" value="{{ $item->item->Batchcode ?? '' }}" placeholder="Batch"></td>
                                            <td><input type="date" class="form-control" name="items[{{ $index }}][expiry]" value="{{ $item->item->Expiry ? \Carbon\Carbon::parse($item->item->Expiry)->format('Y-m-d') : '' }}" placeholder="Expiry"></td>
                                            <td><input type="number" class="form-control qty" name="items[{{ $index }}][qty]" value="{{ $item->quantity }}" min="0" step="1"></td>
                                            <td><input type="number" class="form-control free-qty" name="items[{{ $index }}][free_qty]" value="{{ $item->free_qty ?? 0 }}" min="0" step="0.01"></td>
                                            <td><input type="text" class="form-control" name="items[{{ $index }}][unit]" value="{{ $item->unit }}" placeholder="PCS"></td>
                                            <td><input type="number" class="form-control rate" name="items[{{ $index }}][rate]" value="{{ $item->unit_price }}" min="0" step="0.01"></td>
                                            <td><input type="number" class="form-control sale-rate" name="items[{{ $index }}][sale_rate]" value="{{ $item->sale_rate ?? 0 }}" min="0" step="0.01"></td>
                                            <td><input type="number" class="form-control discount" name="items[{{ $index }}][discount]" value="{{ $item->discount_percent }}" min="0" max="100" step="0.01"></td>
                                            <td><input type="number" class="form-control mrp" name="items[{{ $index }}][mrp]" value="{{ $item->item->Mrp ?? 0 }}" min="0" step="0.01" readonly></td>
                                            <td><input type="number" class="form-control gst" name="items[{{ $index }}][gst]" value="{{ $item->tax_rate }}" min="0" max="100" step="0.01"></td>
                                            <td>
                                                <input type="text" class="form-control amount" value="₹{{ number_format($item->line_total, 2) }}" readonly>
                                                <input type="hidden" class="amount_numeric" name="items[{{ $index }}][line_total]" value="{{ $item->line_total }}">
                                            </td>
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="row g-2 mt-2">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control form-control-sm" id="paid_amount" name="paid_amount" value="{{ old('paid_amount', $invoice->paid_amount ?? 0) }}" min="0" step="0.01">
                                </div>
                                <div class="col-md-4">
                        ...
                        <div class="card-body p-2" style="background-color: #f8f9fa;">
                            ...
                            <div class="row g-2 mb-2">
                                <div class="col-md-1">
                                    ...
                                    <input type="number" class="form-control form-control-sm" id="case_qty" name="case_qty" value="{{ old('case_qty', $invoice->case_qty ?? 0) }}" min="0" step="1">
                                </div>
                                <div class="col-md-1">
                                    <label class="form-label fw-bold mb-1 small">Box</label>
                                    <input type="number" class="form-control form-control-sm" id="box_qty" name="box_qty" value="{{ old('box_qty', $invoice->box_qty ?? 0) }}" min="0" step="1">
                                </div>
                                <div class="col-md-2 text-center" style="border: 2px solid #dee2e6; padding: 5px; border-radius: 4px;">
                                    <div class="mb-1">
                                        ...
                                        <input type="number" class="form-control form-control-sm" id="cgst_percent" name="cgst_percent" value="{{ old('cgst_percent', $invoice->cgst_percent ?? 0) }}" min="0" max="100" step="0.01">
                                    </div>
                                    <div class="mb-1">
                                        <label class="form-label fw-bold mb-0 small">SGST(%):</label>
                                        <input type="number" class="form-control form-control-sm" id="sgst_percent" name="sgst_percent" value="{{ old('sgst_percent', $invoice->sgst_percent ?? 0) }}" min="0" max="100" step="0.01">
                                    </div>
                                    <div>
                                        <label class="form-label fw-bold mb-0 small">Cess (%):</label>
                                        <input type="number" class="form-control form-control-sm" id="cess_percent" name="cess_percent" value="{{ old('cess_percent', $invoice->cess_percent ?? 0) }}" min="0" max="100" step="0.01">
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <label class="form-label fw-bold mb-1 small">TAX %</label>
                        ...
                        <div class="card-body p-3">
                            <div class="row g-2">
                                <div class="col-md-5">
                                    ...
                                    <textarea class="form-control form-control-sm" id="notes" name="notes" rows="2" placeholder="Additional notes">{{ old('notes', $invoice->notes) }}</textarea>
                                </div>
                                <div class="col-md-5">
                                    <label class="form-label fw-bold mb-1 small">Terms & Conditions</label>
                                    <textarea class="form-control form-control-sm" id="terms_conditions" name="terms_conditions" rows="2" placeholder="Payment terms">{{ old('terms_conditions', $invoice->terms_conditions) }}</textarea>
                                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Start itemIndex from the count of existing items
